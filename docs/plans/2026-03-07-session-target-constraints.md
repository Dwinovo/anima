...
- Modify: `src/presentation/api/schemas/session_action.py`
...
**Files:**
- Modify: `src/domain/session/actions.py`
- Modify: `src/presentation/api/schemas/session_action.py`
- Modify: `tests/presentation/test_session_request_schema.py`
...
- Modify: `src/core/exceptions.py` only if new reasons/messages are needed
- Modify: `tests/usecases/test_event_usecases.py`
