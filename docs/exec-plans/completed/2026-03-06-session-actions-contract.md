...
- Modify: `backend/src/presentation/api/schemas/requests/session.py`
...
Run: `cd backend && uv run pytest backend/tests/usecases/test_session_usecases.py backend/tests/usecases/test_event_usecases.py -q`
...
**Files:**
- Modify: `backend/src/presentation/api/schemas/requests/session.py`
- Modify: `backend/src/presentation/api/schemas/responses/session.py`
- Modify: `backend/src/domain/session/entities.py`
- Modify: `backend/src/domain/session/repository.py`
- Modify: `backend/src/application/usecases/session/create_session.py`
- Modify: `backend/src/application/usecases/session/get_session.py`
- Modify: `backend/src/application/usecases/session/patch_session.py`
- Modify: `backend/src/presentation/api/v1/sessions.py`
...
**Files:**
- Modify: `backend/src/infrastructure/persistence/postgres/models.py`
- Modify: `backend/src/infrastructure/persistence/postgres/repositories/session_repository.py`
- Create: `backend/alembic/versions/20260306_0005_add_actions_to_sessions.py`
...
Run: `cd backend && uv run pytest backend/tests/usecases/test_session_usecases.py -q`
...
- Modify: `backend/tests/usecases/test_event_usecases.py`
- Modify: `backend/pyproject.toml` if JSON Schema validation support is needed
...
Run: `cd backend && uv run pytest backend/tests/presentation/test_session_request_schema.py backend/tests/usecases/test_session_usecases.py backend/tests/usecases/test_event_usecases.py -q`
