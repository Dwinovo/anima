...
**Files:**
- Modify: `backend/tests/usecases/test_get_entity_context_usecase.py`
- Modify: `backend/src/presentation/api/schemas/responses/entity.py`
- Modify: `backend/tests/presentation/` (add or extend response-shape tests if needed)
...
Run: `cd backend && uv run pytest backend/tests/usecases/test_get_entity_context_usecase.py -q`
...
**Files:**
- Modify: `backend/src/application/dto/entity.py`
- Modify: `backend/src/presentation/api/schemas/responses/entity.py`
- Test: `backend/tests/usecases/test_get_entity_context_usecase.py`
...
**Files:**
- Modify: `backend/src/application/usecases/entity/get_entity_context.py`
- Modify: `backend/src/domain/memory/graph_event_repository.py` only if query needs expand
- Test: `backend/tests/usecases/test_get_entity_context_usecase.py`
...
Run: `cd backend && uv run pytest backend/tests/usecases/test_get_entity_context_usecase.py backend/tests/presentation -q`

Expected: PASS.

**Step 2: Run lint**

Run: `cd backend && uv run ruff check backend/src/application/usecases/entity/get_entity_context.py backend/src/application/dto/entity.py backend/src/presentation/api/schemas/responses/entity.py backend/tests/usecases/test_get_entity_context_usecase.py`
